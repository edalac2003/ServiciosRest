...
public class FacturaVentaCtrl extends GenericForwardComposer{
	...
	private static Logger logger = Logger.getLogger(FacturaVentaCtrl.class);
...
//				consecutivo = facturaNgc.consecutivoFactura(tipoFactura);
				consecutivo = facturaNgc.consecutivoFactura("factura venta");
			} catch (ExcepcionesNGC e) {
